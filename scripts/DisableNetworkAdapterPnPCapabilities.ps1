# This script fixes the issue when a VM doesn't respond to ping
		...
		If(Test-Path -Path $KeyPath)
		{
			...
			If($PnPCapabilitiesValue -eq 0)
			{
				...
				{	
					...
					Write """$PhysicalAdapterName"" - The option ""Allow the computer to turn off this device to save power"" was disabled."
				...
				Catch
				{
					Write "Setting the value of properties of PnpCapabilities failed." -ForegroundColor Red
				}
			}
